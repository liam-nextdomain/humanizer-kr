...
LLM을 이용해서 쓴 글에서 미묘하게'AI가 쓴 티'가 난다고 느낀 적 있으신가요? 이왕이면 그 티를 좀 덜 내고 싶다고 생각해 보신 적은요? **Humanizer KR**은 그런 사람들을 위해 만든 스킬입니다. 영어를 타겟으로 하는 **[humanizer](https://github.com/blader/humanizer/tree/main)**, LLM과 사람의 한국어 글쓰기를 분석한 논문 두 편 **[KatFishNet: Detecting LLM-Generated Korean Text through Linguistic Feature Analysis](https://github.com/Shinwoo-Park/katfishnet)**, **[생성형 AI 텍스트와 인간 텍스트의 내용 및 문체 비교 연구](https://www.kci.go.kr/kciportal/ci/sereArticleSearch/ciSereArtiView.kci?sereArticleSearchBean.artiId=ART003291987)** 의 연구 내용을 참고했습니다.
...
**[SKILL.md](references/SKILL.md)**는 이 프로젝트에 아이디어를 제공한 스킬입니다. 영어 텍스트에서 AI 패턴을 제거하는 원본 스킬로, 한국어 버전 개발의 이론적 토대가 되었습니다.
